...
tags:
  ...
  - concurrency
---
推荐阅读: [内存模型与内存序](https://jia.je/hardware/2024/09/04/memory-model-and-memory-ordering)，[Hardware Memory Model](https://research.swtch.com/hwmm)，[Programming Language Memory Models](https://research.swtch.com/plmm)。
